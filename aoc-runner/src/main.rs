                ...
                "2015" => {
                    match day.as_str() {
                        ...
                        "day2" => {
                            match get_input_file(year, day) {
                                Ok(puzzle_input) => {
                                    let _ = aoc2015::day2::run(&puzzle_input);
                                },
                                Err(e) => {
                                    eprintln!("Error: {}", e);
                                    process::exit(1);
                        ...
                        "day3" => {
                            match get_input_file(year, day) {
                                Ok(puzzle_input) => {
                                    let _ = aoc2015::day3::run_part1(&puzzle_input);
                                    let _ = aoc2015::day3::run_part2(&puzzle_input);
                                },
                                Err(e) => {
                                    eprintln!("Error: {}", e);
                                    process::exit(1);
                ...
                "2024" => {
                    match day.as_str() {
                        ...
                        "day2" => {
                            match get_input_file(year, day) {
                                Ok(puzzle_input) => {
                                    let _ = aoc2024::day2::run(&puzzle_input);
                                },
                                Err(e) => {
                                    eprintln!("Error: {}", e);
                                    process::exit(1);
                        ...
                        "day3" => {
                            match get_input_file(year, day) {
                                Ok(puzzle_input) => {
                                    let _ = aoc2024::day3::run(&puzzle_input);
                                },
                                Err(e) => {
                                    eprintln!("Error: {}", e);
                                    process::exit(1);
                        ...
                        "day4" => {
                            match get_input_file(year, day) {
                                Ok(puzzle_input) => {
                                    let _ = aoc2024::day4::run(&puzzle_input);
                                },
                                Err(e) => {
                                    eprintln!("Error: {}", e);
                                    process::exit(1);
